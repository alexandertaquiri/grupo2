      					...
      					<?php
							echo"<h4>CALIFICACIONES</h4>";
      						for($x = 1; $x <=$num ; $x++){
								...
								$calificado=mysqli_fetch_array(mysqli_query($con,"SELECT elige.comentario FROM elige WHERE idPostulacion=$idPostulacion"));
								...
								<?php
								}else if($calificado[0]!=NULL && $replica[0]==NULL){
