...
?>
		...
		<link rel="stylesheet" type="text/css" href="css/estilos.css">
			<form name="formulario2" action="actualizarReplica.php" class="form" method="post">
				...
				<div class="content">
					...
					<textarea type="input" maxlength="100" rows="10" name="replica" class="input"  required="required" size=25></textarea></br>
