...
<html>
<head>
	<title>Mis Gauchadas Favoritas</title>
</head>
<body>
	<?php
		...
		//consulta para mostrar las publicaciones marcadas como favoritas
		$consultax= "SELECT DISTINCT publicacion.idPublicacion, publicacion.idUsuario, publicacion.titulo, publicacion.ciudad, publicacion.descripcion, publicacion.imagen
					FROM favorito
					INNER JOIN publicacion ON (favorito.idPublicacion=publicacion.idPublicacion)
