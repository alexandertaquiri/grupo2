                        ...
                        <div class="modal-body">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form id="buyPoints" method="POST" action="submit.php" enctype="multipart/form-data">
                                        <div class="controls">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="space-down"><label><span class="glyphicon glyphicon-credit-card"></span> Tipo de Tarjeta *</label></div>
                                                    <label class="radio-inline col-md-3"><input type="radio" name="card"><img class="img-responsive" src="imgs/mastercard.jpg" alt="Chania"></label>
                                                    <label class="radio-inline col-md-3"><input type="radio" name="card"><img class="img-responsive" src="imgs/visa.jpg" alt="Chania"></label>
                                                    <label class="radio-inline col-md-3"><input type="radio" name="card"><img class="img-responsive" src="imgs/card.png" alt="Chania"></label>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label" for="nCard"><span class="glyphicon glyphicon-sort-by-order"></span> Número de Tarjeta *</label>
                                                            <input id="nCard" type="text" name="nCard" class="form-control" placeholder="Número de tarjeta *" required="">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="security"><span class="glyphicon glyphicon-lock"></span> Código *</label>
                                                        <input id="security" name="security" type="number" class="form-control" placeholder="Código *" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <br>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="points" name="points" type="number" class="form-control" placeholder="Puntos *" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
